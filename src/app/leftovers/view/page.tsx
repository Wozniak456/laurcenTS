...
export default function FilterableTable() {
  const [StartSaldoDate, setStartSaldoDate] = useState<string | undefined>(
    undefined
  );
  const [EndSaldoDate, setEndSaldoDate] = useState<string | undefined>(
    undefined
  );
    ...
    <div className="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-75 flex justify-center items-center">
      ...
      <div className="bg-white p-8 rounded shadow-lg w-2/5">
        <h1 className="text-3xl font-bold mb-8">
          Розрахунок залишків кормів на складі
        </h1>

            ...
            <div>
                <div className="flex m-4 justify-between center">
                    ...
                    <div className="flex gap-4">
                        <Link href={`/pools/${pool.id}/edit`} className="p-2 border rounded">
                            Edit
                        </Link>
                ...
                <div className="p-3 border rounded border-gray-200">
                    <label><b>prod_line_id:</b></label>
                    <h2>
                        {pool.prod_line_id} 
                    </h2>
                </div>
                <div className="p-3 border rounded border-gray-200">
                    <label><b>cleaning_frequency:</b></label>
                    <h2>
                        {pool.cleaning_frequency} 
                    </h2>
                </div>
                <div className="p-3 border rounded border-gray-200">
                    <label><b>water_temperature:</b></label>
                    <h2>
                        {pool.water_temperature} 
                    </h2>
                </div>
                <div className="p-3 border rounded border-gray-200">
                    <label><b>x_location:</b></label>
                    <h2>
                        {pool.x_location} 
                    </h2>
                </div>
                <div className="p-3 border rounded border-gray-200">
                    <label><b>y_location:</b></label>
                    <h2>
                        {pool.y_location} 
                    </h2>
                </div>
                <div className="p-3 border rounded border-gray-200">
                    <label><b>pool_height:</b></label>
                    <h2>
                        {pool.pool_height} 
                    </h2>
                </div>
                <div className="p-3 border rounded border-gray-200">
                    <label><b>pool_width:</b></label>
                    <h2>
                        {pool.pool_width} 
                    </h2>
                </div>
                <div className="p-3 border rounded border-gray-200">
                    <label><b>pool_length:</b></label>
                    <h2>
                        {pool.pool_length} 
                    </h2>
                </div>

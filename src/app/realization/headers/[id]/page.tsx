        ...
        <div className="flex flex-col gap-4 ">
            <div>
              <div className="flex justify-between mb-4">
                <h1 className="text-xl font-bold">Вибуткова накладна №{Number(header.id)}</h1>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  <tr>
                  <td className="px-2 py-2 border border-gray-400 text-center">{header.doc_id ? Number(header.doc_id) : ''}</td>
            ...
            <table className="w-full text-sm">
                <thead>
                    <tr className="bg-blue-100">
                        <th className="px-2 py-2 text-center border border-gray-400"># Line</th>
                        <th className="px-2 py-2 text-center border border-gray-400">Item Id </th>
                        <th className="px-2 py-2 text-center border border-gray-400">Item name</th> 
                        <th className="px-2 py-2 text-center border border-gray-400">Qty</th>
                        <th className="px-2 py-2 text-center border border-gray-400">Unit</th>
                        <th colSpan={3} className="py-2 text-center border border-gray-400">Edit</th>            
                    </tr> 
                </thead>
                <tbody>
                  {header.saleslines.map((line, index) => (
                    <tr key={index}>
                      ...
                      <td className="px-2 py-2 border border-gray-400 text-center">{line.quantity}</td>  
                      <td className="px-2 py-2 border border-gray-400 text-center">{line.units.name}</td>  
                    </tr>

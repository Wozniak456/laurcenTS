...
export default function ActualizationPage({
  ...
  feeds,
  today,
}: ActualizationPageProps) {
  const [formState, action] = useFormState(actions.initialStocking, {
    message: "",
  });
      ...
      <div className="max-w-3xl w-full bg-white shadow-md rounded-lg p-8">
        ...
        <form className="space-y-6" action={action}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div>
              {poolInfo.batch && poolInfo.fishWeight ? (
                <Input
                  label="Сер. вага, г"

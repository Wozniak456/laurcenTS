...
// type HandlePriorityComponentProps = {
//     location: LocationComponentType,
// }

// export default function HandlePriorityComponent({location} : HandlePriorityComponentProps) {
...
//             {showForm && <PriorityForm setShowForm={setShowForm} location={location} priorities={priorities}/>}
//         </>
//     )
// }
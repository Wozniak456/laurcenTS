            ...
            <TableBody>
                ...
                .map((item, index) => (
                    <TableRow key={index}>
                        ...
                        <TableCell className="text-center">{item.feed_type_name}</TableCell>
                        <TableCell className="text-center">{item.item_name}</TableCell>
                        <TableCell className="text-center">{item.start_saldo.toFixed(2)}</TableCell>
                        <TableCell className="text-center">{item.incoming.toFixed(2)}</TableCell>
                        <TableCell className="text-center">{item.outcoming.toFixed(2)}</TableCell>
                        <TableCell className="text-center">{item.end_saldo.toFixed(2)}</TableCell>
                    </TableRow>
                    )) : 
                    <TableRow>

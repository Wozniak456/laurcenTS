...
export async function editItem(
  ...
  try {
    ...
    const item_type_id: number = parseInt(
      formData.get("item_type_id") as string
    );
    const item_id: number = parseInt(formData.get("item_id") as string);
    const default_unit_id: number = parseInt(
      formData.get("default_unit_id") as string
    );
    const vendor_id: number = parseInt(formData.get("vendor_id") as string);
    const feed_type_id: number = parseInt(
      formData.get("feed_type_id") as string
    );
